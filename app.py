...
pickle_in = open("C:\\Users\\Hp\\Desktop\\model24.pkl", 'rb') 
model = pickle.load(pickle_in)

pickle_in = open("C:\\Users\\Hp\\Desktop\\vectorizer.pkl", 'rb') 
...
if option == "Sentiment Analysis":
    ...
    if st.button("Predict sentiment"):
        ...
        if model.predict(transformed_input) == -1:
            st.write(" NEGATIVE: Try to improving your Hotel! You got a Negative Review with 1 or 2 star Rating 😔")
        elif    model.predict(transformed_input) == 1:
            st.write(" POSITIVE: Great Work there! Your Hotel got a Positive Review with 4 or 5 star Rating 😃")
            st.balloons()
        else:
            st.write(" SATISFACTORY: Good Work there, but there's room for improvement! You got a Neutral Review with 3 star Rating 😶")
